        ...
        <tr>
            <td align="center" style="padding:30px 0;">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.1); overflow:hidden;">
                    ...
                    <!-- Header -->
                    <tr>
                        <td align="center" style="background:linear-gradient(90deg,#ff6b6b,#ff8e53); padding:20px;">
                    ...
                    <tr>
                        <td style="padding:30px; color:#333;">
                            ...
                            <h3 style="margin-top:25px; color:#ff6b6b;">Your Account Details:</h3>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td align="center" style="background:#f1f1f1; padding:15px; font-size:13px; color:#666;">
                            Thanks,<br>
                            {{ config('app.name') }}
                        </td>
                    </tr>
